...
namespace Drupal\az_wysiwyg\Tests;
...
class FootnoteTest extends WebTestBase {
   ...
   * @var array
   */
  public static $modules = array('node', 'az_wysiwyg', 'filter');
  ...
  public function setUp() {
    ...
    $permissions = array(
      ...
      'create az_wysiwyg_content_type content',
      'edit any az_wysiwyg_content_type content',
    ...
    $this->createTextFormat('az_wysiwyg_text_format', array('filter_az_wysiwyg'));
  }
   ...
   * to run this way.
   * There we test if the az_wysiwyg are converted using [fn] and <fn>, and test
  ...
  protected function testNodeContent() {
    ...
    // Css file:
    $this->assertRaw('/assets/css/az_wysiwyg.css', 'The css file /assets/css/az_wysiwyg is present.');
  }
